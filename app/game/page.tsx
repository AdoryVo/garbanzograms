...
import { PlayingCardUtil } from "./playing-card-util"
import { PlayingCardTool } from "./playing-card-tool"
...
export default function DragAndDropExample() {
	...
	return (
		<div className="tldraw__editor" style={{ position: 'fixed', inset: 0 }}>
			<Tldraw
				shapeUtils={[MyGridShapeUtil, MyCounterShapeUtil, PlayingCardUtil]}
				tools={[PlayingCardTool]}
				onMount={(editor) => {
